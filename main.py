...
import dotenv
from utils.extract import url_to_pdf_content
...
rag_add_content_action = composio_toolset.execute_action(action=Action.RAGTOOL_ADD_CONTENT_TO_RAG_TOOL, params={"content": pdf_content})
